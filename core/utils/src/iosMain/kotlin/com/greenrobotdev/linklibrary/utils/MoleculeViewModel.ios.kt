...
/**
 * iOS-specific actual implementation of MoleculeViewModel.
 * Provides lifecycle management without AndroidX dependencies.
 */
actual abstract class MoleculeViewModel<Event, Model> {
     ...
     * iOS implementation uses Main dispatcher with supervisor job.
     */
     ...
     * iOS implementation cancels the coroutine job.
     */
